...
def compare_heterogeneous_matroid_constraints_algorithms_egalitarian_utilitarian():  #egalitarian: prioritizes the poor
    ...
    input_ranges_intersection = { #an input range which is appropriate for all the algorithms
        ...
        per_category_capped_round_robin_optimized,capped_round_robin_optimized,per_category_capped_round_robin_optimized,iterated_priority_matching_optimized,egalitarian_algorithm,utilitarian_algorithm]
    }
    input_ranges_algorithm_1 = {#same capacities else doesn't matter
        ...
        per_category_round_robin_optimized,egalitarian_algorithm,utilitarian_algorithm,iterated_maximum_matching]
    ...
    input_ranges_algorithm_2 = {# crr -> single category
        ...
        'num_of_agents': range(1,100),
        'algorithm': [
                      capped_round_robin,capped_round_robin_optimized,egalitarian_algorithm,utilitarian_algorithm]
    }
    input_ranges_algorithm_3 = { # back and forth crr -> 2 categories
        'equal_capacities': [True,False],
        'equal_valuations': [True,False],
        ...
        'num_of_agents': range(1, 100),
        'algorithm': [
            two_categories_capped_round_robin,two_categories_capped_round_robin_optimized,two_categories_capped_round_robin_optimized_threads,two_categories_capped_round_robin_optimized_threads_cython,utilitarian_algorithm,egalitarian_algorithm]
    }
    input_ranges_algorithm_4 = { # per-category crr -> equal valuations
        'equal_capacities': [True,False],
        'equal_valuations': [True],
        ...
        'num_of_agents': range(1, 100),
        'algorithm': [
            per_category_capped_round_robin, per_category_capped_round_robin_optimized,egalitarian_algorithm,utilitarian_algorithm]
    }
    input_ranges_algorithm_5 = {# iterated priority-matching -> binary valuations
        'equal_capacities': [True,False],
        'equal_valuations': [True,False],
        ...
        'num_of_agents': range(1, 100),
        'algorithm': [
            iterated_priority_matching,iterated_priority_matching_optimized,egalitarian_algorithm,utilitarian_algorithm]
    }
...
if __name__ == '__main__':
    ...
    experiments_csv.single_plot_results('results/egalitarian_utilitarian_comparison_heterogeneous_constraints_algorithms_bigData.csv',filter={},x_field='num_of_agents',y_field='current_algorithm_bundle_min_value',z_field='algorithm',save_to_file='results/egalitarian_comparison_heterogeneous_constraints_algorithms_optimized_bigData.png') # egalitarian ratio plot
    experiments_csv.single_plot_results('results/egalitarian_utilitarian_comparison_heterogeneous_constraints_algorithms_bigData.csv',filter={},x_field='num_of_agents',y_field='current_algorithm_bundle_sum',z_field='algorithm',save_to_file='results/utilitarian_comparison_heterogeneous_constraints_algorithms_optimized_bigData.png') # utilitarian ratio plot
    experiments_csv.single_plot_results('results/egalitarian_utilitarian_comparison_heterogeneous_constraints_algorithms_bigData.csv',filter={},x_field='num_of_agents',y_field='runtime',z_field='algorithm',save_to_file='results/runtime_comparison_heterogeneous_constraints_algorithms_optimized_bigData.png') # runtime plot
    pass
#
